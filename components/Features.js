...
const Features = () => {
  return (
    <div id="features">
      ...
      <p className="text-gray-600 dark:text-gray-300">Diary Help is a website that helps you manage your dairy business with ease. Whether you are a milk producer, seller, or consumer, you can use our website to keep track of your transactions, expenses, and profits.
