        ...
        <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
          ...
          >
            <ul className="list-inside list-disc space-y-8">
              ...
              <li><Link href="/prices" className="transition hover:text-primary">Pricing</Link></li>
              <li><Link href="/contact" className="transition hover:text-primary">Contact</Link></li>
            </ul>
  
            <ul role="list" className="space-y-8">
              <li>
                <a href="https://www.youtube.com/@isahildhillon" className="flex items-center space-x-3 transition hover:text-primary">
                  <svg
              ...
              <li>
                <a href="https://www.instagram.com/isahildhillon" className="flex items-center space-x-3 transition hover:text-primary">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="w-5"
