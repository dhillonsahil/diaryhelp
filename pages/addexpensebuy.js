...
const purchaseMilk = () => {
  ...
  border:'1px solid black'
   ...
   <label className='text-lg my-2 font-semibold' htmlFor="consumerSelect">Debit or Credit Type :</label>
                            ...
                            <RadioGroup className=' px-4 py-2.5 mt-2 text-lg transition duration-500 ease-in-out transform border-transparent rounded-lg  focus:border-blueGray-500 focus:bg-white  focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ' defaultValue={"Buy"} onChange={(e)=>{
                              setSelectedtype(e);
                             }}>
                            <Stack spacing={5} direction='row'>
                              <Radio colorScheme='red' value='Sell'>
